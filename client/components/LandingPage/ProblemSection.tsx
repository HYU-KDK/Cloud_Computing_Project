        ...
        <section className="py-24 px-6 bg-white border-b-[3px] border-black">
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-6">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-red-100 border-2 border-red-500 text-red-600 font-extrabold text-xs uppercase tracking-wider rounded-md">
                ...
                <div className="relative bg-gray-50 border-[3px] border-black p-8 md:p-12 shadow-[12px_12px_0px_0px_#00C853]">
                    <div className="absolute -top-6 -right-6 bg-[#00C853] text-white p-4 font-black text-xl border-[3px] border-black rotate-12 shadow-lg">
                        SOLUTION!
                    </div>
